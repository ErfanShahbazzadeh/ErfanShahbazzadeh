...
| [PDF-Speech-Reader](https://github.com/ErfanShahbazzadeh/PDF-Speech-Reader) | A simple code that extracts text from a PDF file and reads it using text-to-speech. | Python |
